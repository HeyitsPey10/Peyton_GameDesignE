...
class ItemsFallingFromSky():
    ...
    def __init__(self,parent,canvas,player,board):
        ...
        self.goodItems = ["star1.png","star2.png","star3.png"]
...
#     def loadScore(self):
#         with open("catch the fruit\high-score.txt", "r") as data:
#             return int(data.read())                
        
#     def saveScore(self):
#         if self.score > self.highScore:
#             with open("catch the fruit\high-score.txt", "w") as data:
#                 data.write(str(self.score))
...
#         self.goodItems = ["images\star1.png","images\star1.png","images\star1.png"]
#         self.badItems = ["images\star2.png","images\star2.png","images\star2.png"]
        
#         # create falling items
#         if self.isgood:   
#             self.itemPhoto = tkinter.PhotoImage(file = "catch the fruit\images\{}" .format( choice(self.goodItems) ) )
#             self.fallItem = self.canvas.create_image( (self.xPosition, 50) , image=self.itemPhoto , tag="good" )
#         else:
#             self.itemPhoto = tkinter.PhotoImage(file = "catch the fruit\images\{}" . format( choice(self.badItems) ) )
#             self.fallItem = self.canvas.create_image( (self.xPosition, 50) , image=self.itemPhoto , tag="bad" )
...
#         # player character
#         self.playerPhoto = tkinter.PhotoImage(file = "images{}" .format( "\\basket.png" ) )
#         self.playerChar = self.canvas.create_image( (475, 560) , image=self.playerPhoto , tag="player" )
